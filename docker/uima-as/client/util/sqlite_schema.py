...
# Create table
c.execute('''
CREATE TABLE source_note (id INTEGER PRIMARY KEY, service_id INTEGER, note_id INTEGER, version_id INTEGER, rtf2plain TEXT, rtf_pipeline TEXT, b9 TEXT, mm TEXT, clamp TEXT, ctakes TEXT, error TEXT)
''')
c.execute('''
