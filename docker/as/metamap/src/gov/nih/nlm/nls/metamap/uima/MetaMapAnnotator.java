...
public class MetaMapAnnotator extends JCasAnnotator_ImplBase implements
  ...
  public void initialize(UimaContext aContext) throws ResourceInitializationException {
    ...
    this.getParameters();
    if (this.hostFromEnv != null){
      if (this.portFromEnv == null) this.portFromEnv = "8066";
      this.api = new MetaMapApiImpl(this.hostFromEnv, Integer.parseInt(this.portFromEnv), 0);
    } else {
    ...
    for (Result result: resultList) {
      if (result != null) {
        try {
          ...
          List<gov.nih.nlm.nls.metamap.uima.ts.AcronymAbbrev> acronymsAbbrevs = processAcronymsAbbrevs(jcas, result.getAcronymsAbbrevsList());
          ...
          List<org.metamap.uima.ts.Negation> negations = processNegations(jcas, result.getNegationList(), citationStart);
          ...
          List<org.metamap.uima.ts.Utterance> utterances = processUtterances(jcas, 
  ...
  List<gov.nih.nlm.nls.metamap.uima.ts.AcronymAbbrev> processAcronymsAbbrevs(JCas jcas, List<AcronymsAbbrevs> acronymsAbbrevsList)
    throws Exception
  {
    List<gov.nih.nlm.nls.metamap.uima.ts.AcronymAbbrev> acronymAbbrevList =
      new ArrayList<gov.nih.nlm.nls.metamap.uima.ts.AcronymAbbrev>
  ...
  List<org.metamap.uima.ts.Negation> processNegations(JCas jcas, List<Negation> aNegationList, int citationStart)
    throws Exception
  {
    /** uima types from metamap uima package */
    List<org.metamap.uima.ts.Negation> negationList =
      new ArrayList<org.metamap.uima.ts.Negation>
      (aNegationList.size());
  ...
  List<org.metamap.uima.ts.Utterance> processUtterances(JCas jcas, List<Utterance> anUtteranceList, int citationStart)
    throws Exception
  {
    String docText = jcas.getDocumentText().replace("\n"," ");
    /** uima types from metamap uima package */
    List<org.metamap.uima.ts.Utterance> utteranceList =
      new ArrayList<org.metamap.uima.ts.Utterance>
  ...
  List<org.metamap.uima.ts.Candidate> processCandidates(JCas jcas, List<Ev> candidateList, int citationStart)
    throws Exception 
  {
    String docText = jcas.getDocumentText();
  ...
  List<org.metamap.uima.ts.Mapping> processMappings(JCas jcas, PCM pcm, int citationStart)
    throws Exception
  {
  ...
  public FSArray createSpanFSArray (JCas jcas, List<Position> positionList, int citationStart) {
  ...
  public List<Span> createSpanList(JCas jcas, List<Position> positionList, int citationStart) {
  ...
  /** add any extra options (besides machine output) to be used for processing, see parameter <name>metamap_options</name>*/
  ...
  private void getParameters() {
    ...
    this.hostFromEnv = System.getenv("MMSERVER_HOST");
    this.portFromEnv = System.getenv("MMSERVER_PORT");
  }
  /**
